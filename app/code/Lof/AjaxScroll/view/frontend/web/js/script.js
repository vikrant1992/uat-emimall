...
IASTriggerExtension.prototype.defaults = {
    text: 'Load more',
    html: '<div class="ias-trigger ias-trigger-next loadMoreBtn" style="text-align: center; cursor: pointer; font-size: 10px;"><a style="text-transform:uppercase" href="javascript:void(0);">{text}</a></div>',
    textPrev: 'Load previous items',
    htmlPrev: '<div class="ias-trigger ias-trigger-prev loadMoreBtn" style="text-align: center; cursor: pointer; font-size: 10px;"><a style="text-transform:uppercase" href="javascript:void(0);">{text}</a></div>',
    offset: 0
};

...
class Edit extends \Cybage\Storelocator\Controller\Adminhtml\Dealer
{
    ...
    public function __construct(
        ...
        \Cybage\Storelocator\Model\Dropdown\Group $group
    ) {
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Dealer %1', $model->getId()) : __('New Dealer'));
        return $resultPage;
    }
}

<?php
/**
 * BFL Cybage_Customtinymce
 *
 * @category   Cybage_Customtinymce Module
 * @package    BFL Cybage_Customtinymce
 * @copyright  2019 All rights reserved.
 * @license    Proprietary
 * @author     BFL (bajaj finserv limited)
 */
namespace Cybage\Customtinymce\Plugin;
 ...
 protected $activeEditor;
    ...
    public function afterGetConfig(
        ...
        if(strpos($editor,'tinymce4Adapter')){
            ...
            $settings['valid_children'] = '+body[style],+div[a],+p[strong|a|#text],+a[div],+a[p]';
